...
Cf2py intent(out) ANV, BNV

      IMPLICIT NONE

! Arguments:

      DOUBLE PRECISION GSCA,QBACK,QQEXT,QQSCA,XX,YY
      DOUBLE COMPLEX RRFRL1,RRFRL2
...
! Local variables:
      ...
      INTEGER IFLAG,N,NSTOP,nmax,CURS
      DOUBLE PRECISION
     ...
     &   XBACK,XI0Y,XI1Y,XIY,
     &   X1,X2,Y2
      DOUBLE COMPLEX ANV(NDn), BNV(NDn)
...
! returns:
!      ANV: vector with the values of an
!      BNV: vector with values of bn
!
