#!/bin/bash
cd /sessions/eloquent-admiring-ptolemy/mnt/pymiedap
/sessions/eloquent-admiring-ptolemy/mamba/envs/pymiedap/bin/python3.11 << 'PYEOF' > /sessions/eloquent-admiring-ptolemy/mnt/pymiedap/nmug50_result.txt 2>&1
...
PYEOF
echo "DONE" >> /sessions/eloquent-admiring-ptolemy/mnt/pymiedap/nmug50_result.txt
