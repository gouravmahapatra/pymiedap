...
* See license.md or http://gitlab.com/loic.cg.rossi/pymiedap for details.
      ...
      SUBROUTINE setfouascii(coefs,ncoefs,a,b,xmu,nmug,
...
C      DOUBLE PRECISION coefs(nmatMAX,nmatMAX,0:ncoefsMAX,nlaysMAX),
C     .                 xmu(nmuMAX),a(nlaysMAX),b(nlaysMAX)

C      INTEGER M0(nlaysMAX),M1(nlaysMAX),M2(nlaysMAX),
C     .        iadd(nlaysMAX,0:nfouMAX)
