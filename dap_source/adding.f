...
* See license.md or http://gitlab.com/loic.cg.rossi/pymiedap for details.
      ...
      SUBROUTINE adding(a,b,coefsin,ncoefs,max_ncoefs,
     .                  nmug,nmat,surfmatin,nlays,rfou,xmu,m)
Cf2py intent(in) a,b,coefs,ncoefs,max_ncoefs,nmug,nmat,surfmatin,nlays
Cf2py intent(out) rfou,xmu,m
**********************************************************************
...
**********************************************************************
     ...
     .          coefsin(nmatMAX,nmatMAX,0:ncoefsMAX,nlaysMAX)
      ...
      REAL*8 xmu(nmug+1), smf(nmug+1)

      REAL*8 rfou((nmug+1)*nmat,nmug+1,0:nfouMAX)

      REAL*8, DIMENSION(:,:), ALLOCATABLE :: Rmbot, Rmtop,Tmbot,
     .          Tmtop,Rmsbot,surfmat,Zmplus,Zmmin,w !rank 2

      REAL*8, DIMENSION(:), ALLOCATABLE ::ebbot,ebtop !rank 1
