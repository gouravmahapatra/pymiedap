...
#               self.rd1 = np.hstack((self.rd1,new_data.rd1))
    ...
    def get_bande(self,lw_noise='lw_NEB_g2_t28.txt',sw_noise='sw_NEB_g2_t28.txt'):
        ...
        # observation points
        for j in xrange(nobs):  #loop on observation times
...
def processing_orbits(orbit_n,orbit_a,orbit_max=200,list=False,
                      orbit_range=False,
                      path_data='/net/nfs/spicav/share/Anna/polarization/calibrated_data2013/',
                      calibration_year=2013,
                      path_geo='/net/nfs/home/rossi/these/donnes_spicav/geom/',
                      lw_noise='/net/nfs/home/rossi/these/donnes_spicav/lw_NEB_g2_t28.txt',
                      sw_noise='/net/nfs/home/rossi/these/donnes_spicav/sw_NEB_g2_t28.txt'):
    """
    Processing_orbits
    ...
    # ORBIT RANGE
        ...
        for num in xrange(orbit_n,orbit_max):
...
def fake_data():
    """ a small function to create a fake nadir obs"""
    data = Data()
    data.geo = Geo()
